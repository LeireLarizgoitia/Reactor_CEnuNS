...
mm = [100.00000000000002, 125.89254117941673,158.48931924611137, 199.526231496888, 251.18864315095807]
#mm = [316.227766016838, 398.10717055349737, 501.1872336272724, 630.9573444801934, 794.3282347242816]
...
np.savetxt('/scratch/llarizgoitia/Reactor/Reactor_CEnuNS/ZeN_chisq/Events_ve1_m_23_1.txt', np.c_[m_list,c_list,ese_list])
np.savetxt('/scratch/llarizgoitia/Reactor/Reactor_CEnuNS/ZeN_chisq/Events_ve2_m_23_1.txt', np.c_[m_list,c_list,ese_list2])
