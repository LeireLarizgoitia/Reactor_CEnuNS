...
#mm = [10.000000000000002, 12.589254117941673, 15.848931924611137, 19.9526231496888, 25.118864315095807]
mm = [31.6227766016838, 39.810717055349737, 50.11872336272724, 63.09573444801934, 79.43282347242816]
...
np.savetxt('/scratch/llarizgoitia/Reactor/Reactor_CEnuNS/ZeN_chisq/Events_ve1_m_12_2.txt', np.c_[m_list,c_list,ese_list])
np.savetxt('/scratch/llarizgoitia/Reactor/Reactor_CEnuNS/ZeN_chisq/Events_ve2_m_12_2.txt', np.c_[m_list,c_list,ese_list2])
