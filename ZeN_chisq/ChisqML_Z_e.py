...
def fcn_np(par):
    ...
    centre_e, events_e = fnc_events_MHVE_e(qe,qnu, par_g,par[8])
...
np.savetxt('/scratch/llarizgoitia/Reactor/Reactor_CEnuNS/ZeN_chisq/chisq_ML_e.txt', np.c_[chisq_ML,chisqndf])
np.savetxt('/scratch/llarizgoitia/Reactor/Reactor_CEnuNS/ZeN_chisq/MLvalues_e.txt', np.c_[m.values])

txt_file = open("/scratch/llarizgoitia/Reactor/Reactor_CEnuNS/ZeN_chisq/MHVE_Fef_Ze_mparams.txt", "w")
