...
#mm = [1.0000000000000002, 1.2589254117941673, 1.5848931924611137, 1.99526231496888,2.5118864315095807]
mm = [3.16227766016838,3.9810717055349737, 5.011872336272724, 6.309573444801934, 7.943282347242816]
...
np.savetxt('/scratch/llarizgoitia/Reactor/Reactor_CEnuNS/ZeN_chisq/Events_ve1_m_01_2.txt', np.c_[m_list,c_list,ese_list])
np.savetxt('/scratch/llarizgoitia/Reactor/Reactor_CEnuNS/ZeN_chisq/Events_ve2_m_01_2.txt', np.c_[m_list,c_list,ese_list2])
